	...
	<div class="flybuy">
		<div class="navbar">
			...
			<ul>
				...
				<li><a class="active" href="Paymentapp_login.jsp">Payment Application</a></li>
			</ul>	
		</div>
	</div>
        <!-- Close Header -->
        <!-- Start Banner Hero -->
            ...
            <center><h1 class="feature-work-heading h2 py-3 semi-bold-600">Payment Application</h1></center><br><br>
            <div class="row pb-4">
                <div class="col-lg-5 px-5">
                    <center><img src="assets/img/paymentappln.png" width="430" height="400" /></center>
                </div>
                <div class="col-lg-4">
                    <form class="contact-form row" method="post" action="payapp" role="form">
                        <div class="col-12">
