	...
	<div class="flybuy">
		<div class="navbar">
			...
			<ul>
				...
				<li><a class="active" href="Merchant_login.jsp">Merchant</a></li>
        ...
        <!-- Start Banner Hero -->
            ...
            <center><h1 class="feature-work-heading h2 py-3 semi-bold-600">Merchant Login</h1></center><br><br>
            <div class="row pb-5">
                <div class="col-lg-5 px-5">
                    <center><img src="assets/img/merchantlogin.jpg" width="430" height="400" /></center>
                </div>
                <div class="col-lg-4">
