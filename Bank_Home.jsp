...
<html lang="en">
	...
	<div class="flybuy">
		<div class="navbar">
			...
			<ul>
				<li><a class="active" href="Bank_Home.jsp">Home</a></li>
                ...
                <div class="row d-flex d-flex align-items-center">
                    <div class="col-lg-12">
                        <center><h1 class="feature-work-heading h2 py-3 semi-bold-600">Online Bank</h1></center><br>
                        <center> <img src="img/bankhome.jpg" width="550" height="350" /></center>
                    </div>
                </div>
