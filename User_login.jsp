...
<html lang="en">
	...
	<div class="flybuy">
        ...
        <!-- Start Banner Hero -->
            ...
            <center><h1 class="feature-work-heading h2 py-3 semi-bold-600" >User Login</h1></center><br><br>
            <div class="row pb-4">
                <div class="col-lg-6">
                    <center><img src="assets/img/userlogin.jpg" width="400" height="400" /></center>
                </div>
                <div class="col-lg-5">
                    <form class="contact-form row" method="post" action="user_signin.jsp" role="form">
                        <div class="col-12">
                            <div class="form-group mb-4">
                                <label>Email :</label>
                                <input type="email" class="form-control form-control-lg light-300" id="email" pattern="[^@\s]+@[^@\s]+\.[^@\s]+" title="Invalid email address" name="email" placeholder="Enter Your Email" required="required" />
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-group mb-4">
                        ...
                        <div class="col-md-12">
                            ...
                            <a href="user_signup.jsp" class="btn btn-secondary rounded-pill px-md-5 px-4 py-2 radius-0 text-light light-300">Register!</a>
